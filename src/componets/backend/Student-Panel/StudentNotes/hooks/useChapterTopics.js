  ...
  const loadChapterData = async () => {
    try {
      ...
      const coursesResponse = await axios.get(
        `https://srs-server-lac.vercel.app/api/course/student/${studentData.id}/courses`
      );
      ...
      if (
        ...
        const response = await axios.get(
          `https://srs-server-lac.vercel.app/api/course/student/${studentData.id}/course/${courseId}/subject/${subjectName}/chapter/${chapterNumber}/topics`
        );
