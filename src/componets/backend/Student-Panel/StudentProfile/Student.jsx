  ...
  const uploadImage = async file => {
    try {
      ...
      const response = await axios.post(
        `https://srs-server-lac.vercel.app/api/auth/studentRegistration/upload-image/${profileId}`,
        formData,
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://srs-server-lac.vercel.app/api/auth/studentRegistration/profile/${profileId}`,
        submissionData
      );
